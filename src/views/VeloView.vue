                ...
                <div class=" lg:grid lg:gap-x-0 lg:grid-cols-2 ">
                    ...
                    <div class="pl-5 pr-5 lg:pl-0 lg:pr-0">
                        ...
                        <div class="lg:flex lg:justify-center">
                            <div class="p-6 bg-velo_green_clear font-poppins lg:w-1/2">
                                <div class="mb-8">
                                    <p class="text-sm  font-extrabold bord_transparent_noir uppercase">Secondary </p>
                                    <p class="text-sm text-noir_impur font-extrabold uppercase letter_spacing">Color</p>
                        ...
                        <div class="lg:flex ">
                            ...
                            <div
                                ...
                                <div class="bloc_hover p-6">
                                    ...
                                    <p class=" text-sm text-blanc_impur font-bold  ">Figma was used to make the layout of
                                        the website</p>
                            ...
                            <div
                                ...
                                <div class="bloc_hover p-6">
                                    ...
                                    <p class=" text-sm text-blanc_impur font-bold  ">Wordpress was used the CMS used to
                        ...
                        <div class="lg:flex justify-center">
                            <div
                                ...
                                <div class="bloc_hover p-6">
                                    ...
                                    <p class=" text-sm text-blanc_impur font-bold  ">CSS was used to give a unique style to
                                        the site</p>
