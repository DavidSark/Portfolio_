                    ...
                    <div class=" lg:grid lg:gap-x-0 lg:grid-cols-2 ">
                        ...
                        <div class="">
                            <div class="px-5 lg:px-0">
                                <div class="  ">
                                    <img src="@/assets/img/velotaf.png">
                                </div>
            ...
            <div class="lg:flex ">
                ...
                <div
                    ...
                    <div class="bloc_hover p-6">
                        ...
                        <p class=" text-sm text-blanc_impur font-bold  ">Wordpress was used the CMS used to create the website</p>

                    </div>
                    <div class="flex justify-center items-center flex-col space-y-4">

                        <img class="w-14" src="@/assets/img/wordpress.svg">
                        <p class="text-sm text-noir_impur font-extrabold uppercase letter_spacing light_anim3">wordpress</p>
